...
const reduxStore = configureStore({
    ...
    getDefaultMiddleware({
      serializableCheck: {
        ...
        ignoredPaths: ['page.imageUploadQueue', 'page.imagePanels', 'page.attachmentsUploadQueue', 'page.attachmentPanels', 'page.videosUploadQueue', 'page.videoPanels', 'page.abortController', 'page.xhr', 'page.writer'],
      },
    }),
})
