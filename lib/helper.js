...
export function usingServiceWorker() {
    ...
    const result = (browserInfo.isChrome && (process.env.NEXT_PUBLIC_platform !== 'android')) || (!browserInfo.isIPhone && !browserInfo.isIPad && !browserInfo.isAndroid) && (browserInfo.isChrome || browserInfo.isFirefox);
