...
export function PostCall({ api, body }) {
    return new Promise((resolve, reject) => {
        const domain =  'https://api.bsafes.com'; //'https://u0wqkryedk.execute-api.us-east-1.amazonaws.com'
        //const domain = 'https://fo4x871jr1.execute-api.us-east-1.amazonaws.com'; //open
