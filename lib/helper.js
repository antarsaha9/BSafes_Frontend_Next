...
export function usingServiceWorker() {
    ...
    const result = (!browserInfo.isIPhone && !browserInfo.isIPad && !browserInfo.isAndroid) && (browserInfo.isChrome || browserInfo.isFirefox);
...
export function PostCall({ api, body }) {
    return new Promise((resolve, reject) => {
        const domain = 'https://fo4x871jr1.execute-api.us-east-1.amazonaws.com';
