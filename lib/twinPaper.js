    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            imgElement.onload = function () {
                ...
                const draft = twinPaperTemplate;
                draft.elements[0].width = elementWidth;
                draft.elements[0].height = elementHeight;
                const fileId = `twin_${Date.now()}`;
                draft.elements[0].fileId = fileId;
                const imageFileData = {
                ...
                draft.files[fileId] = imageFileData;
