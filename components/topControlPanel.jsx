                ...
                <Col xs={12} sm={{ span: 10, offset: 1 }} lg={{ span: 8, offset: 2 }}>
                    <Card className={`${BSafesStyle.containerControlPanel}`}>
                        <Card.Body className=''>
                            <Row>
                                <Col xs={4}>
                                    {((pageActivity === 0) && (containerActivity === 0)) && (workspaceId && workspaceId.startsWith("d:") && containerInWorkspace === workspaceId) && <Button onClick={onHomeClicked} variant='link' size='sm' className='text-white'><i className="fa fa-home fa-lg" aria-hidden="true"></i></Button>}
