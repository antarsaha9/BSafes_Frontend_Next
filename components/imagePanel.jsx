    ...
    return (
        <div>
            ...
            <Row>
                <Col xs={8} sm={9}>
                    <div className="pt-2">
                        <Editor editorId={panelIndex} showWriteIcon={true} mode={editorMode} content={panel.words} onContentChanged={onContentChanged} showPen={false} editable={editable} hideIfEmpty={true} uploadImages={uploadImages} />
                    </div>   
                </Col>
