...
export default function PageCommonControls({isEditing, onWrite, onSave, onCancel, canEdit=true}) {
    return (
        <>
            {(canEdit && !isEditing)?<Button onClick={onWrite} className={`${BSafesStyle.btnCircle} ${BSafesStyle.btnFloating} ${BSafesStyle.btnFloatingWrite}`}><i className="fa fa-pencil fa-2x" aria-hidden="true"></i></Button>:<></>}
